...
<center>
<form action="consreg.php" method="POST" style="width: 90%; "  style="height: 100%; " >	
					<div id="search">
						</br>&nbsp; <b>CHOOSE DISTRIBUTOR </b>
							<select name="names" style="height:30px" style="width:100px" >
					
					<option value="S4">SELECT DISTRIBUTOR</option>
					<?php
						...
						?>
							...
							<input type="submit" name="submit" class="sbutton"  size="100" maxlength="" value="Check consomation" style="height:35px" />
						</div>
					</form></center>
